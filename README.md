# 🧩 Problems to Solve — Then and Now

Modern computation is evolving faster than ever — pushing boundaries of physics, architecture, and energy efficiency. From early mechanical machines to CMOS & FinFET breakthroughs, humanity has always pushed toward one goal:

> **Unlock Zetta-scale computing to solve the world’s most complex scientific and engineering challenges.**


---

## 1️⃣ In the Beginning… — Early Computing History
...
### **Evolution Focus:**
**Smaller → Faster → More efficient → More capable**

---

## 2️⃣ Next-Generation… — Modern High-Impact Challenges

Today’s computing must solve globally critical, computation-heavy missions:

- 🌍 **Earth–water system & sustainability modeling**
- 🌧 **Weather prediction & hyper-accurate forecasting**
- 🌋 **Earthquake simulation & disaster mitigation**
- 🔬 **Atomic-scale modeling & semiconductor innovation**
- 🌌 **Validating fundamental laws of physics**
- 🚄 **Virtual particle accelerators**
- ❄️ **Room-temperature superconductivity discovery**
- 🧬 **Genomics, drug discovery & precision medicine**
...
# 📈 50 Years of Microprocessor Scaling — Moore’s Law and Beyond

For over five decades, semiconductor progress has been guided by **Moore’s Law**, which states:
...
- ⚙️ **Transistor Count** (orange)
- 🚀 **Single-thread Performance** (blue)
- ⚡ **Operating Frequency** (green)
- 🔥 **Power Consumption** (red)
- 🧠 **Number of Cores** (black)

---

## 🔍 Key Observations from the Trend Data

### **1970s – Early 2000s: Golden Era of Frequency Scaling**
...
## 🚀 Zetta-Scale Needs Continuous Innovation

Reaching **Zetta-scale computing** in future decades requires reinventing scaling beyond classical Moore’s Law.
...
> Scaling is no longer just about shrinking —  
> **it’s about smarter design, power efficiency, and architecture-first innovation.**
...
Smartphones transitioned from “communication tools” to **general-purpose supercomputers on battery power**, used globally by billions.

---

## ⚠ Performance Limitations in Mobile Devices
...
After ~2006, pushing CPUs beyond ~2–3 GHz became thermally impractical for smartphones. Instead of increasing frequency, engineers shifted focus:

### ⚙️ The New Mobile Strategy
...
## 🚀 Implications for Zetta-Scale Computing

The mobile revolution didn’t just change consumer devices —  
**it redefined the trajectory of the entire semiconductor industry.**

### How Mobile Pushed Us Toward Zetta-Scale

#### 1️⃣ Efficiency Became the Priority  
...
#### 2️⃣ Heterogeneous Compute Became Standard  
...
#### 3️⃣ Workload Offloading to Datacenters  
...
However, the rate of improvement is slowing — and the next milestone, **Zetta-scale computing**, requires breakthroughs far beyond traditional scaling.
...
|-----|------------------|----------------|------|-------------|
| **GigaFLOPS** | 10⁹ FLOPS | Early workstation systems | ~1984 | ~1 kW |
| **TeraFLOPS** | 10¹² FLOPS | Cray XT5 Jaguar | 2008 | 7 MW |
| **PetaFLOPS** | 10¹⁵ FLOPS | Titan (Cray XK6) | 2012 | 9 MW |
| **ExaFLOPS** | 10¹⁸ FLOPS | Frontier, USA | 2021 | 29 MW |
| **ZettaFLOPS (Goal)** | 10²¹ FLOPS | Future HPC | ~2035 | **50–100 MW** |

### 🧮 Understanding the Scaling Ratio

Each generation represents a **1000× increase** in computational capability. Historically, reaching each milestone has taken about **8–14 years**, driven by:
...
### If scaled linearly from today’s systems:
> **ZettaFLOPS would require 50–100 MW**  
> *(equivalent to powering an entire small city)*

This creates major challenges:

- 🥵 Cooling becomes prohibitively expensive  
- 💸 Energy cost becomes unsustainable  
- 🌍 Environmental impact increases sharply  
- 🔌 Power delivery infrastructure becomes a bottleneck  

Even today’s Exascale machines push the limits with ~30 MW consumption.

---

## 🔥 Computing Needs Are Growing Faster Than We Can Scale
...
#### 🛰️ Planetary-Scale Climate & Space Simulation  
...
## 🧠 What Must Evolve to Reach Zetta Scale?

Achieving Zetta-scale computing requires a **full-stack revolution**, not just faster chips.

### 🔹 1. Device-Level Innovation  
- FinFET → GAAFET → CFET → 2D Materials (MoS₂), CNT-FETs, Spintronics  
- 100× reduction in energy per computation  
- Improved channel control and reduced leakage  
- Lower interconnect resistance and capacitance  

### 🔹 2. 3D Stacking & Advanced Packaging  
...
### 🔹 5. Rack-Level “Single Socket” Architecture  
...
If innovation continues across **materials → devices → packaging → architecture → software**, then:

> 🟢 **Zetta-scale supercomputing is achievable within the next 10–12 years.**
...
The journey to Zetta-scale computing isn’t merely a chase for higher FLOPS.  
...
> **Device → Circuit → Architecture → System → Application**

Your exploration of **FinFET-based circuit design and characterization** in this workshop is the foundation for understanding how the next generation of computing will be built — one transistor at a time.

---

## 📍 50 Years of Microprocessor Trend Data

For more than half a century, semiconductor progress has been governed by **Moore’s Law** — the observation that the number of transistors on an integrated circuit doubles roughly every **18–24 months**.  
This single trend has shaped all of modern computing, enabling continuous improvement in:

- 🧠 **CPU Single-thread performance** – how fast a single core can execute instructions  
- ⚡ **Clock frequency** – how many cycles per second the CPU operates  
- 🔥 **Compute per Watt** – performance efficiency  
- 🧩 **Core count scaling** – parallelism within a chip  
...
## 🔍 What the Graph Tells Us — Deeper Interpretation

| Trend | Observation | Impact | What It Really Means |
|------|------------|--------|----------------------|
| 🟧 **Transistor Count** | Continues exponential rise | Enables more compute per die | Physical scaling (smaller transistors) continues, but at higher cost and complexity |
| 🔵 **Single-thread Performance** | Growth slows significantly | Cannot rely on frequency boosts | Architectural innovation (out-of-order, speculation, caching) hits diminishing returns |
| 🟩 **Frequency Scaling** | Plateaus around 2005 | “Power Wall” stops GHz race | Increasing frequency drastically increases heat → chips throttle |
| 🔴 **Typical CPU Power** | Carefully capped (<200W for CPUs) | Avoids thermal failure and expensive packaging | Industry prioritizes energy efficiency over raw speed |
| ⚫ **Core Count** | Rapid rise after ~2005 | Multicore becomes default scaling method | Parallel workloads become necessary for performance gains |

---

## 📱 The Mobile Revolution — A Turning Point in Computing History
...
Mobile innovation didn’t just transform phones — it reshaped **desktop, server, and datacenter processor design**, too.

---

## ⚠️ Why Moore’s Law Still Matters (and Why It’s Harder Than Ever)

Achieving the next frontier — **Zetta-Scale Computing (10²¹ FLOPS)** — requires exponential improvements in compute density and efficiency.
...
Despite these challenges, **we must keep scaling**, even if Moore’s Law doesn’t continue in its traditional form.

---

## 🧠 From Chips → Systems: The New Era of Scaling
...
|------|----------------------|----------------|
| **Transistor** | FinFET → GAAFET → 2D materials → CNT-FETs | Lower leakage, higher electrostatic control |
...
Scaling is now a **full-stack challenge** — from atoms to applications.

---

## 🎯 Conclusion — The Future Depends on New Scaling Paradigms

> **Zetta-Scale computing (10²¹ FLOPS)** will only be possible if Moore’s Law continues through *non-classical* scaling.

This means:
- New transistor architectures (FinFET → GAAFET → CFET)  
...
> **Moore’s Law is not dead — it is transforming.**  
> And this transformation will define the next era of supercomputing.

---

# CMOS Evolution and Next-Gen Device Candidates 🚀  
...
- 🏗️ System-level scaling (STCO)

As transistors shrink toward atomic dimensions, traditional scaling breaks down — forcing the industry to introduce **new pillars of innovation** at key technological inflection points.

---

## 🕓 Timeline of CMOS Evolution (Past → Present → Future)

Each decade brought a new fundamental challenge — and a breakthrough to overcome it.

| Year / Node | Major Innovation Pillar | Technology Introduced | Why This Was Needed |
|------------|-----------------------|----------------------|---------------------|
| **1990s — 130nm → 90nm** | Channel engineering | **Strain-Silicon** | Boost carrier mobility as physical shrinking slowed |
| **2007 — 45nm** | Gate Stack revolution | **High-k + Metal Gate (HKMG)** | Reduce gate leakage caused by ultra-thin SiO₂ |
| **2012 — 22nm** | Transistor Architecture | **FinFET becomes mass-commercial** | Improve electrostatic control as planar MOSFETs hit limits |
| **2019 — 7nm EUV era** | Patterning breakthrough | **Extreme UV lithography (EUV)** | Enable further scaling without insane multi-patterning |
| **2022 — 3nm** | Channel & structure innovation | **SiGe channels, GAAFET R&D** | Prepare for gate-all-around control at 2nm nodes |
| **2025–2027 — 2nm roadmap** | Interconnect scaling | **Ru/Co wires, backside power delivery (BSPDN)** | Reduce RC delay & power routing bottlenecks |
| **Beyond 2028 — sub-1.8nm** | Novel channel materials | **2D materials (MoS₂, WS₂)** | Combat short-channel effects when silicon fails |
| **2030+ — 1nm target** | Vertical integration | **Vertical FETs, 3D stacked devices, chiplets** | Move beyond single-die scaling limits |

---

## 🔺 Scaling Drivers Through the Decades (What Changed and Why)

### 📍 1990–2010 → **Geometry + Strain Scaling**
- Shrink gate lengths
- Introduce strain engineering  
- Improve dopant profiles  
➡ Pure geometry scaling still viable.

### 📍 2010–2020 → **Architecture Scaling (FinFET Era)**
- Planar MOSFET → 3D FinFET  
- Better electrostatic control  
- Reduced leakage  
➡ Architecture replaces geometry as primary driver.

### 📍 2020–2030 → **Material + Lithography Era**
- EUV replaces complex multi-patterning  
- New interconnect metals (Ru, Co)  
- SiGe and nanosheet channels  
➡ Materials enable continued density gains.

### 📍 2030+ → **3D + System Scaling (STCO Era)**
- Chiplets  
- 3D die stacking  
- Backside power delivery  
➡ Performance now comes from *systems*, not transistors.

> 📌 The industry moved from **simple shrinking** → **clever engineering** → **system-wide optimization**.

---

## 🔬 The Five Scaling Pillars — Evolution of Each
...
|-------|----------------|-----------------------|----------------|
| **Patterning** | ArF @ 248nm (90nm era) | EUV @ 7nm | High-NA EUV → sub-1nm |
| **Gate Stack** | HKMG @ 45nm | Lower leakage & better reliability | Negative Capacitance FETs (NC-FETs), Ferroelectric materials |
| **Channel Material** | SiGe R&D @ 22nm | Nanosheet & SiGe channels | 2D semiconductors (MoS₂, WS₂), CNT-FETs |
| **Interconnects** | Cu adoption @ 180nm | Ru/Co + backside PDN | Topological semimetals & 3D interconnect fabrics |
| **Device Structure** | Planar → FinFET @ 22nm | GAAFET/nanosheet @ 3nm | 3DS-FET, Vertical FETs (VFET), Stacked CFETs |

This marks the transition from **device-only scaling** → **materials + system co-scaling**.

---

## 🧩 DTCO + STCO: The New Form of Moore’s Law
...
- Co-designing:
  ...
  - Routing tracks  
  - Transistor geometry  
- Ensures PPA (Performance–Power–Area) gains even when pure scaling slows.

### 🏗️ STCO — *System–Technology Co-Optimization*
- Emerged with **3nm and chiplet architectures**
- Co-designing:
  - Multiple dies  
  - Packaging  
  - Interposers & stacked memory  
- Treats the **entire package as the new “scaling unit”**.

> 📌 Future scaling will be defined not by “transistor count per chip” but by **performance per package** and **compute per watt per system**.

---

## 🎯 Scaling Toward Zetta-Scale Computing (10²¹ FLOPS)
...
- Beyond that → **silicon bandgap + electrostatic limits**
...
- 3D stacking enables “vertical Moore’s Law”

---

## 📌 Summary: How Scaling Has Evolved Over Time

| Era | Primary Scaling Method | Example Technologies |
|-----|------------------------|----------------------|
| **1990–2010** (Golden Moore’s Law) | **Physical shrinking** | Planar → Strain → HKMG |
| **2012–2022** (Electrostatic Era) | **3D device structures** | FinFET |
| **2022–2028** (Material–Interconnect Era) | **Novel materials + EUV** | Ru, Co, SiGe, EUV |
| **2028+** (System Scaling Era) | **Chiplets + advanced packaging** | STCO, 3D ICs |

> 🚀 The journey toward **1nm** and **ZettaFLOPS** requires a synergy of **materials science, device engineering, architecture, and system design** — all scaling together.
